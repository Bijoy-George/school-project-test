...
<a href="{{route('student.create')}}"class="btn  btn-primary"><i class="fas fa-plus"></i> New Student</a>
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                	<form action="{{url('/student-list')}}" method="POST" class="listing form-common d-flex" name="form-common">
                  	@csrf
