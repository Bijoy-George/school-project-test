...
<a href="{{route('class.create')}}"class="btn  btn-primary"><i class="fas fa-plus"></i> New Class</a>
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                	<form action="{{url('/class-list')}}" method="POST" class="listing form-common d-flex" name="form-common">
                  	@csrf
