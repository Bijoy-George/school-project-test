...
<a href="{{route('division.create')}}"class="btn  btn-primary"><i class="fas fa-plus"></i> New Division</a>
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                	<form action="{{url('/division-list')}}" method="POST" class="listing form-common d-flex" name="form-common">
                  	@csrf
