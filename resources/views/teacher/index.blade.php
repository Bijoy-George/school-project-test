...
<a href="{{route('teacher.create')}}"class="btn  btn-primary"><i class="fas fa-plus"></i> New Teacher</a>
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                	<form action="{{url('/teacher-list')}}" method="POST" class="listing form-common d-flex" name="form-common">
                  	@csrf
